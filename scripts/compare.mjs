 ...
 *
 * Usage:
 *   node scripts/compare.mjs                        # Run both + compare
 *   node scripts/compare.mjs --quick                # Just analyze TS output
 *   node scripts/compare.mjs --docker-only          # Just run Docker Python
 */
