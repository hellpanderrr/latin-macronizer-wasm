...
$MorpheusSrcDir = Join-Path $ScriptDir "..\c\src"
$MorpheusIncludeDir = Join-Path $MorpheusSrcDir "includes"
$MorpheusStemlibDir = Join-Path $ScriptDir "..\c\stemlib"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  2. Use MorpheusTagger class from native/morpheus/js/MorpheusTagger.js" -ForegroundColor White
