...
if ($emccPath) {
    ...
    $emccArgs = @(
        "rftagger/src/embind-wrapper.C",
        "rftagger/src/rft-annotate.C",
        "rftagger/src/io.C",
        "rftagger/src/DataMapping.C",
        "rftagger/src/SuffixLexicon.C",
        "rftagger/src/POSTagger.C",
        "rftagger/src/Lexicon.C",
        "rftagger/src/Entry.C",
        "-O3",
        "-s WASM=1",
        "-s MODULARIZE=1",
